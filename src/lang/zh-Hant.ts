export const languageChineseTraditional = {
    ...
    "openRouterReasoning": "推理",
    "openRouterReasoningEnabled": "啟用推理",
    "openRouterReasoningEffort": "推理強度",
    "openRouterReasoningTokenBudget": "推理 Token 預算",
    "generateImageConsent": "外掛程式 {} 想使用你的 OpenRouter 金鑰產生圖片。這可能產生費用。允許這次請求嗎？",
    "openRouterImageModel": "OpenRouter 圖片模型",
    "openRouterImageSettings": "OpenRouter 圖片生成設定",
    "openRouterImageProviderDefault": "供應商預設值",
    "openRouterImageOptionsHelp": "只顯示所選模型支援的參數。選擇供應商預設值即可使用模型的預設設定。",
    "openRouterImageAspectRatio": "長寬比",
    "openRouterImageResolution": "解析度",
    "openRouterImageQuality": "品質",
    "openRouterImageOutputFormat": "輸出格式",
    "openRouterImageModelsFailed": "無法載入 OpenRouter 圖片模型。請重新開啟設定後再試。",
    "openRouterImageReference": "參考圖片（選填）",
    "openRouterImageReferenceHelp": "支援 10 MB 以下的 PNG、JPEG 或 WebP。所選模型必須支援參考圖片。",
    "openRouterImageReferenceInvalid": "請選擇 10 MB 以下的 PNG、JPEG 或 WebP 圖片。",
    "openRouterImageReferenceReadFailed": "無法讀取圖片，請嘗試其他檔案。",
    "openRouterImageReferenceSupported": "支援參考圖片",
