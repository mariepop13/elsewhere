export const languageSpanish = {
    ...
    "openRouterReasoning": "Razonamiento",
    "openRouterReasoningEnabled": "Activar razonamiento",
    "openRouterReasoningEffort": "Esfuerzo de razonamiento",
    "openRouterReasoningTokenBudget": "Presupuesto de tokens de razonamiento",
    "generateImageConsent": "El plugin {} quiere generar una imagen con tu clave de OpenRouter. Esto puede generar un cargo. ¿Permitir esta solicitud?",
    "openRouterImageModel": "Modelo de imagen OpenRouter",
    "openRouterImageSettings": "Generación de imágenes OpenRouter",
    "openRouterImageProviderDefault": "Valor predeterminado del proveedor",
    "openRouterImageOptionsHelp": "Solo se muestran los parámetros compatibles con el modelo seleccionado. Usa el valor predeterminado del proveedor para mantener la configuración del modelo.",
    "openRouterImageAspectRatio": "Relación de aspecto",
    "openRouterImageResolution": "Resolución",
    "openRouterImageQuality": "Calidad",
    "openRouterImageOutputFormat": "Formato de salida",
    "openRouterImageModelsFailed": "No se pudieron cargar los modelos de imagen de OpenRouter. Vuelve a abrir los ajustes para intentarlo de nuevo.",
    "openRouterImageReference": "Imagen de referencia (opcional)",
    "openRouterImageReferenceHelp": "PNG, JPEG o WebP de menos de 10 MB. El modelo elegido debe admitir imágenes de referencia.",
    "openRouterImageReferenceInvalid": "Elige una imagen PNG, JPEG o WebP de menos de 10 MB.",
    "openRouterImageReferenceReadFailed": "No se pudo leer la imagen. Prueba con otro archivo.",
    "openRouterImageReferenceSupported": "Admite imágenes de referencia",
    ...
    "recentChatsEmpty": "Todavía no hay personajes ni conversaciones.",
