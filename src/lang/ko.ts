export const languageKorean = {
    ...
    "openRouterReasoning": "추론",
    "openRouterReasoningEnabled": "추론 활성화",
    "openRouterReasoningEffort": "추론 강도",
    "openRouterReasoningTokenBudget": "추론 토큰 예산",
    "generateImageConsent": "플러그인 {}이(가) OpenRouter 키로 이미지를 생성하려고 합니다. 비용이 발생할 수 있습니다. 이 요청을 허용할까요?",
    "openRouterImageModel": "OpenRouter 이미지 모델",
    "openRouterImageSettings": "OpenRouter 이미지 생성 설정",
    "openRouterImageProviderDefault": "제공업체 기본값",
    "openRouterImageOptionsHelp": "선택한 모델이 지원하는 설정만 표시됩니다. 제공업체 기본값을 선택하면 모델 기본 설정이 사용됩니다.",
    "openRouterImageAspectRatio": "가로세로 비율",
    "openRouterImageResolution": "해상도",
    "openRouterImageQuality": "품질",
    "openRouterImageOutputFormat": "출력 형식",
    "openRouterImageModelsFailed": "OpenRouter 이미지 모델을 불러오지 못했습니다. 설정을 다시 열어 재시도하세요.",
    "openRouterImageReference": "참조 이미지 (선택 사항)",
    "openRouterImageReferenceHelp": "10MB 미만의 PNG, JPEG 또는 WebP 파일을 선택하세요. 선택한 모델이 참조 이미지를 지원해야 합니다.",
    "openRouterImageReferenceInvalid": "10MB 미만의 PNG, JPEG 또는 WebP 이미지를 선택하세요.",
    "openRouterImageReferenceReadFailed": "이미지를 읽을 수 없습니다. 다른 파일을 사용해 보세요.",
    "openRouterImageReferenceSupported": "참조 이미지 지원",
    ...
    "recentChatsEmpty": "아직 캐릭터나 대화가 없습니다.",
