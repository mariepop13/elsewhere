export const languageEnglish = {
    ...
    openRouterReasoningEnabled: "Enable Reasoning",
    openRouterReasoningEffort: "Reasoning Effort",
    openRouterReasoningTokenBudget: "Reasoning Token Budget",
    ...
    generateImageConsent: "Plugin {} wants to generate an image with your OpenRouter key. This may incur a charge. Allow this request?",
    openRouterImageModel: "OpenRouter image model",
    openRouterImageSettings: "OpenRouter image generation",
    openRouterImageProviderDefault: "Provider default",
    openRouterImageOptionsHelp: "Only parameters supported by the selected model are shown. Leave a field at Provider default to use the model's default.",
    openRouterImageAspectRatio: "Aspect ratio",
    openRouterImageResolution: "Resolution",
    openRouterImageQuality: "Quality",
    openRouterImageOutputFormat: "Output format",
    openRouterImageModelsFailed: "OpenRouter image models could not be loaded. Reopen settings to retry.",
    openRouterImageReference: "Reference image (optional)",
    openRouterImageReferenceHelp: "PNG, JPEG, or WebP under 10 MB. The selected model must support image references.",
    openRouterImageReferenceInvalid: "Choose a PNG, JPEG, or WebP image under 10 MB.",
    openRouterImageReferenceReadFailed: "Could not read the image. Try another file.",
    openRouterImageReferenceSupported: "Supports image references",
