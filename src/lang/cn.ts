export const languageChinese = {
    ...
    "openRouterReasoningEnabled": "启用推理",
    "openRouterReasoningEffort": "推理强度",
    "openRouterReasoningTokenBudget": "推理 Token 预算",
    "generateImageConsent": "插件 {} 想使用你的 OpenRouter 密钥生成图片。这可能产生费用。允许这次请求吗？",
    "openRouterImageModel": "OpenRouter 图片模型",
    "openRouterImageSettings": "OpenRouter 图片生成设置",
    "openRouterImageProviderDefault": "提供商默认值",
    "openRouterImageOptionsHelp": "仅显示所选模型支持的参数。选择提供商默认值以使用模型默认设置。",
    "openRouterImageAspectRatio": "宽高比",
    "openRouterImageResolution": "分辨率",
    "openRouterImageQuality": "质量",
    "openRouterImageOutputFormat": "输出格式",
    "openRouterImageModelsFailed": "无法加载 OpenRouter 图片模型。请重新打开设置后重试。",
    "openRouterImageReference": "参考图片（可选）",
    "openRouterImageReferenceHelp": "支持 10 MB 以下的 PNG、JPEG 或 WebP。所选模型必须支持参考图片。",
    "openRouterImageReferenceInvalid": "请选择 10 MB 以下的 PNG、JPEG 或 WebP 图片。",
    "openRouterImageReferenceReadFailed": "无法读取图片，请尝试其他文件。",
    "openRouterImageReferenceSupported": "支持参考图片",
