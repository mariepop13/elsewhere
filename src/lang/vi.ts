export const languageVietnamese = {
    ...
    "openRouterReasoning": "Lập luận",
    "openRouterReasoningEnabled": "Bật lập luận",
    "openRouterReasoningEffort": "Mức độ lập luận",
    "openRouterReasoningTokenBudget": "Ngân sách token lập luận",
    "generateImageConsent": "Plugin {} muốn tạo ảnh bằng khóa OpenRouter của bạn. Việc này có thể phát sinh phí. Cho phép yêu cầu này?",
    "openRouterImageModel": "Mô hình ảnh OpenRouter",
    "openRouterImageSettings": "Cài đặt tạo ảnh OpenRouter",
    "openRouterImageProviderDefault": "Mặc định của nhà cung cấp",
    "openRouterImageOptionsHelp": "Chỉ hiển thị các tham số mà mô hình đã chọn hỗ trợ. Chọn mặc định của nhà cung cấp để dùng cài đặt mặc định của mô hình.",
    "openRouterImageAspectRatio": "Tỷ lệ khung hình",
    "openRouterImageResolution": "Độ phân giải",
    "openRouterImageQuality": "Chất lượng",
    "openRouterImageOutputFormat": "Định dạng đầu ra",
    "openRouterImageModelsFailed": "Không thể tải danh sách mô hình ảnh OpenRouter. Hãy mở lại phần cài đặt để thử lại.",
    "openRouterImageReference": "Ảnh tham chiếu (không bắt buộc)",
    "openRouterImageReferenceHelp": "PNG, JPEG hoặc WebP dưới 10 MB. Mô hình đã chọn phải hỗ trợ ảnh tham chiếu.",
    "openRouterImageReferenceInvalid": "Chọn ảnh PNG, JPEG hoặc WebP dưới 10 MB.",
    "openRouterImageReferenceReadFailed": "Không thể đọc ảnh. Hãy thử tệp khác.",
    "openRouterImageReferenceSupported": "Hỗ trợ ảnh tham chiếu",
    ...
    "recentChatsEmpty": "Chưa có nhân vật hoặc cuộc trò chuyện nào.",
